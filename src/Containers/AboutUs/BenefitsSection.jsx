...
const BenefitSection = () => {
  return (
    <div className="flex lg:flex-row flex-col justify-around items-start gap-y-10 my-[70px] text-center text-white lg:text-left">
      <div className="flex flex-col flex-[0.4] gap-8">
        <h2 className="font-chakra font-semibold text-5xl leading-[120%]">
          You Innovate,
          <br />
